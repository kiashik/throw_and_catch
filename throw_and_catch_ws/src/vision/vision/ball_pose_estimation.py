...
class BallPoseEstimation(Node):
    ...
    def visualize_pose(self):
        ...
        cv2.circle(vis_image, center, radius=5, color=(0, 255, 0), thickness=-1)
        cv2.circle(vis_image, center, radius=pixel_radius, color=(0, 255, 0), thickness=2)  # Actual detected boundary
